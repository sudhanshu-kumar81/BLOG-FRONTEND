     ...
     <div className="relative w-full ">
      <div className=" mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          ...
          <span className="font-extrabold m-3 ">BLOG</span>
        </div>
        ...
        {login ? (<>
          <div className="hidden grow items-start lg:flex">
            ...
            <NavLink to='/logout'>
              <button
                type="button"
                className="rounded-md bg-black px-7 py-3 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              >
                Logout
              </button>
            </NavLink>
            ...
            <div className="hidden grow items-start lg:flex">
              <ul className="ml-12 inline-flex space-x-8 p-5">
                <NavLink to='/'>
                  <li className="text-sm font-extrabold text-gray-800 hover:text-gray-900 ">
                    HOME
                  </li>
                </NavLink>
              </ul>
